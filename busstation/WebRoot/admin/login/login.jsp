...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    ...
    <form action="adlogin.action" method="post" name="adlogin" class="form form-horizontal">
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60d;</i></label>
        <div class="formControls col-xs-8">
          <input id="adminname" name="adminuser.adminName" type="text" placeholder="姓名" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="adpassword" name="adminuser.adminPassword" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
...
<div class="footer">Copyright 网上客运 by H-ui.admin v3.1</div>
