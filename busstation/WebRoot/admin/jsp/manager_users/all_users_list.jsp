...
<div class="page-container">	
	<div class="mt-20">
		<table class="table table-border table-bordered table-bg table-hover table-sort table-responsive">
			...
			<tbody>
				<s:iterator value="#request['alluser']" var="allusers" status="st">
				<tr class="text-c">
					<td><s:property value="#allusers.name"/></td>
					<td><s:property value="#allusers.username"/></td>
					<td><s:property value="#allusers.sex"/></td>
					<td><s:property value="#allusers.idCard"/></td>		
					<td><s:property value="#allusers.phone"/></td>
				</tr>
				</s:iterator>
			</tbody>
		</table>
