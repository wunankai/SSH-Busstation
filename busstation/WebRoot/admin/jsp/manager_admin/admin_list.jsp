...
<html>
  ...
  <body>
	...
	<table class="table table-border table-bordered table-bg">
		<thead>
			<tr>
				<th scope="col" colspan="4">管理员列表</th>
			</tr>
			<tr class="text-c">
				<th width="40">ID</th>
				<th width="150">姓名</th>
		...
		<tbody>
				<s:iterator value="#request['admins']" var="admin" status="st">
					<tr class="text-c">
						<td><span id="adminId"><s:property value="#admin.adminId"/></span></td>
						
						<td><s:property value="#admin.adminName"></s:property>
						
						<td>
							<span id="adminPhone"><s:property value="#admin.adminPhone"/></span>
						...
						<td class="td-manage">
							...
							<a title="提交" href="javascript:;"  id="submitt" onclick="submitAdmin(this,'<s:property value="#admin.adminId"/>')" class="ml-5" style="text-decoration:none;display:none"><i class="Hui-iconfont">&#xe632;</i></a> 
						</td>
					</tr>
				</s:iterator>
		</tbody>
